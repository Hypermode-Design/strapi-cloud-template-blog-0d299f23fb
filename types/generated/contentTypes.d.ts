...
export interface ApiFontFont extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Font files and information';
    displayName: 'Font';
    pluralName: 'fonts';
    singularName: 'font';
  };
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<
      ['serif', 'sans-serif', 'display', 'handwriting', 'monospace', 'variable']
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiFoundryFoundry extends Struct.CollectionTypeSchema {
  collectionName: 'foundries';
  info: {
    description: 'Font foundries and developers';
    displayName: 'Foundry';
    pluralName: 'foundries';
    singularName: 'foundry';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    fonts: Schema.Attribute.Relation<'manyToMany', 'api::font.font'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::foundry.foundry'
